  ...
  // }
    ...
    request(options, (error, response, body) => {
      if(error){console.log(error);}
        ...
        let example = (typeof(dictResponse.results[0].lexicalEntries[0].entries[0].senses[i].markers)==='undefined') ? " " : dictResponse.results[0].lexicalEntries[0].entries[0].senses[i].markers[0].text;  
